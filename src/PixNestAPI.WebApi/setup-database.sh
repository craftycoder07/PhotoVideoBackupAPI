...
# PixNestAPI Database Setup Script
# This script helps set up PostgreSQL for the PixNestAPI

echo "Setting up PostgreSQL database for PixNestAPI..."
...
createdb -U postgres PixNest 2>/dev/null || echo "Database PixNest might already exist"

echo "Creating development database..."
createdb -U postgres PixNest_Dev 2>/dev/null || echo "Database PixNest_Dev might already exist"
...
echo "  Production DB: PixNest"
echo "  Development DB: PixNest_Dev"
