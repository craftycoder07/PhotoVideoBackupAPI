...
1. **Create databases:**
   ```bash
   # Production database
   createdb -U postgres PixNest
   
   # Development database
   createdb -U postgres PixNest_Dev
   ```
...
**Production:**
```
Host=localhost;Database=PixNest;Username=******;Password=******;Port=5432
```

**Development:**
```
Host=localhost;Database=PixNest_Dev;Username=******;Password=******;Port=5432
```
